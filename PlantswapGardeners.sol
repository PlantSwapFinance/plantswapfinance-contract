...
/* LastEdit: 01August2021 10:00
**
** PlantSwap.finance - Gardeners
** Version:         1.1.0
**
** Detail: This contract is minting Gardeners (NFT's)
**          It's plan for the owner of this contract to be PlantswapGardeningBoard
**          and for the different Gardening School and Unisersity to mint NFT's from this contract.
**          To be used for profile picture and other fun stuff.
*/
...
contract PlantswapGardeners is ERC721Enumerable, Ownable {
    ...
    constructor(string memory _baseURI) ERC721("Plantswap.finance Gardeners", "PSG") {
        _setBaseURI(_baseURI);
    }

    /**
     * @dev Get gardenerId for a specific tokenId.
     */
    ...
    /**
     * @dev Get the associated gardenerName for a specific gardenerId.
     */
    ...
    /**
     * @dev Get the associated gardenerName for a unique tokenId.
     */
    ...
    /**
     * @dev Set a unique name for each gardenerId. It is supposed to be called once.
     */
    ...
    /**
     * @dev Set the base URI for the contract.
     */
    function setGardenerBaseURI(string calldata _baseURI) external onlyOwner {
        _setBaseURI(_baseURI);
    }
