...
contract VerticalGarden is ERC20, ReentrancyGuard {
    ...
    BEP20 public rewardToken = BEP20(0x20de22029ab63cf9A7Cf5fEB2b737Ca1eE4c82A6);           // CHESS     // Place here the token that will be receive as reward
    StakedTokenMasterChef public stakedTokenMasterChef = StakedTokenMasterChef(0xD1812e7E28C39e78727592de030fC0e7c366D61a); // PancakeSwap SmartChef   // MasterChef contract for stackedToken
    StakedTokenSmartChef public stakedTokenSmartChef = StakedTokenSmartChef(0xD1812e7E28C39e78727592de030fC0e7c366D61a);    // PancakeSwap SmartChef   // MasterChef contract for stackedToken
