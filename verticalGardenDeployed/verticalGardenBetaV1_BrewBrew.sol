...
contract VerticalGarden is ERC20, ReentrancyGuard {
    ...
    uint16 public verticalGardenStakedTokenMasterChefPid = 251;       // The pid of the MasterChef pool for the StakedToken
    uint16 public verticalGardenMasterGardenerPid = 21;              // The pid of the MasterGardener pool for gStakedToken
    ...
    address public depositFeeAddress = 0x54195fd92Ce010B4273A5948A1061b40Dd944De4;          // Deposit Fee address
    address public devAddress;                                                              // Dev address for maintenance

    BEP20 constant public stakedToken = BEP20(0x790Be81C3cA0e53974bE2688cDb954732C9862e1);  // BREW                 // Place here the token that will be stack
    BEP20 public rewardToken = BEP20(0x790Be81C3cA0e53974bE2688cDb954732C9862e1);           // BREW                 // Place here the token that will be receive as reward
    StakedTokenMasterChef public stakedTokenMasterChef = StakedTokenMasterChef(0xc772955c33088a97D56d0BBf473d05267bC4feBB); // PancakeSwap MasterChef   // MasterChef contract for stackedToken
    StakedTokenSmartChef public stakedTokenSmartChef = StakedTokenSmartChef(0xc772955c33088a97D56d0BBf473d05267bC4feBB);    // PancakeSwap MasterChef   // MasterChef contract for stackedToken
    ...
    constructor() ERC20('gCAKE Plantswap.finance Vertical Garden', 'gCAKE') {
        depositActive = false;
