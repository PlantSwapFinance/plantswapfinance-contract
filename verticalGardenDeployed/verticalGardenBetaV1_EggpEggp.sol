...
contract VerticalGarden is ERC20, ReentrancyGuard {
    ...
    BEP20 constant public stakedToken = BEP20(0x21adB1c644663069e83059AC3f9d9Ca1133D29e4);  // EGGP                 // Place here the token that will be stack
    BEP20 public rewardToken = BEP20(0x21adB1c644663069e83059AC3f9d9Ca1133D29e4);           // EGGP                 // Place here the token that will be receive as reward
    StakedTokenMasterChef public stakedTokenMasterChef = StakedTokenMasterChef(0x5C5c8a3176b98F3409a7E97CCeE5DfF6096Ce44B); // Eggplant MasterChef   // MasterChef contract for stackedToken
    StakedTokenSmartChef public stakedTokenSmartChef = StakedTokenSmartChef(0x5C5c8a3176b98F3409a7E97CCeE5DfF6096Ce44B);    // Eggplant MasterChef   // MasterChef contract for stackedToken
