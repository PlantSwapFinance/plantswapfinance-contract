...
/* LastEdit: 22Jul2021 10:26
**
** PlantSwap.finance - GardeningSchoolOG
** Version:         Beta 0.1
**
...
import "./11_PlantswapGardeningBoard.sol";

contract GardeningSchoolOG is Ownable {
    ...
    uint8 private constant numberGardenersIds = 9;           // number of total series from 1 to 8
