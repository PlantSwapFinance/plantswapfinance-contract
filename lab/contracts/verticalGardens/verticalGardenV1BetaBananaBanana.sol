...
contract VerticalGarden is ERC20, ReentrancyGuard {
    ...
    uint16 public verticalGardenMasterGardenerPid = 25;              // The pid of the MasterGardener pool for gStakedToken
    ...
    BEP20 constant public stakedToken = BEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95);  // BANANA     // Place here the token that will be stack
    BEP20 public rewardToken = BEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95);           // BANANA     // Place here the token that will be receive as reward
    StakedTokenMasterChef public stakedTokenMasterChef = StakedTokenMasterChef(0x5c8D727b265DBAfaba67E050f2f739cAeEB4A6F9); // MasterApe  // MasterChef contract for stackedToken
    StakedTokenSmartChef public stakedTokenSmartChef = StakedTokenSmartChef(0x5c8D727b265DBAfaba67E050f2f739cAeEB4A6F9);    // MasterApe   // MasterChef contract for stackedToken
    ...
    constructor() ERC20('gBanana Plantswap.finance Vertical Garden', 'gBANANA') {
        depositActive = false;
